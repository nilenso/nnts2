...
(deftest list-nested-directories-test
  (let [org-id      (factory/create-org)
        dir-root    (directory-model/create (factory/build-directory "root" org-id nil))
        dir1-level1 (directory-model/create (factory/build-directory "dir1-level1" org-id (:id dir-root)))
        dir2-level1 (directory-model/create (factory/build-directory "dir2-level1" org-id (:id dir-root)))
        dir3-level2 (directory-model/create (factory/build-directory "dir3-level2" org-id (:id dir1-level1)))]
